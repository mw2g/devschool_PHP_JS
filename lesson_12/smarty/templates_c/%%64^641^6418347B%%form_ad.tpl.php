<?php /* Smarty version 2.6.25-dev, created on 2016-02-04 07:44:34
         compiled from form_ad.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'form_ad.tpl', 57, false),)), $this); ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="utf-8">
  ...
  <body style="width:600px;padding: 30px;margin-left: 30%;">
    ...
    <?php if (( ! empty ( $this->_tpl_vars['ads'] ) )): ?> <?php $_smarty_tpl_vars = $this->_tpl_vars;
...
">
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="text" name="seller_name" class="form-control" id="inputEmail3" placeholder="Иван?" value="<?php echo $this->_tpl_vars['display']->getSeller_name(); ?>
">
    </div>
  </div>
  <div class="form-group">
...
<div class="radio">
  ...
  <div class="form-group">
    <div class="col-sm-offset-2 col-sm-10">
      <button type="submit" name="submit" class="btn btn-default"><?php if (isset ( $_GET['click_id'] )): ?>Сохранить<?php else: ?>Добавить<?php endif; ?> объявление</button>

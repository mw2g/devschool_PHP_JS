<?php
    ...
    require_once ("dz7_2_functions.php");           // подключаем файл с функциями
    
    if (file_exists('dz7_bd.txt')){                    // если есть такой файл
        $ads = unserialize(file_get_contents('dz7_bd.txt'));        // расшифровываем данные и записываем их в $ads
    }

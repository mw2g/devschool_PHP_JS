...
(9,	0,	'Лаврентий',	'koba@rosa.ru',	1,	4294967295,	4,	4,	'Куплю эндуро',	'Только в идеальном состоянии',	100000);
...
";
        ...
        if($mysqli->multi_query($dump)){
            echo 'База данных '.$_POST['database'].' успешно добавлена <br> <a href="dz9.php">Перейти на сайт</a><br>';
        }
        else{

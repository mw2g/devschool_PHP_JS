<?php /* Smarty version 2.6.25-dev, created on 2016-02-13 12:33:21
         compiled from oop.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'oop.tpl', 72, false),)), $this); ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="utf-8">
   ...
   <!-- Latest compiled and minified CSS -->
    ...
    <!-- toastmessage -->
    <link type="text/css" href="toastmessage/jquery.toastmessage.css" rel="stylesheet"/>
...
<div class="radio">
  ...
  <div class="form-group">
    <div class="col-sm-offset-2 col-sm-10">
        ...
        <button type="submit" id="submit" class="btn btn-success">Добавить объявление</button>
